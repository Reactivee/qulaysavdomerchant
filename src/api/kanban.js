...
export const endpoints = {
  ...
  updateColumnOrder: '/update-column-credit', // server URL
  deleteColumn: '/delete-column', // server URL
  addItem: '/add-item', // server URL
  editItem: '/edit-item', // server URL
  updateColumnItemOrder: '/update-item-credit', // server URL
  ...
  updateStoryOrder: '/update-story-credit', // server URL
  updateStoryItemOrder: '/update-storyitem-credit', // server URL
